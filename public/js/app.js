...
var rates = {};
var elementUSD = document.querySelector('[data-value="USD"]');
var elementEUR = document.querySelector('[data-value="EUR"]');
var elementGBP = document.querySelector('[data-value="GBP"]'); //Поля для введення суми

var input = document.querySelector('#input');
var result = document.querySelector('#result');
var select = document.querySelector('#select');
getCurrencies();
setInterval(getCurrencies, 10000); //функція отримання  курсу валют
...
function _getCurrencies() {
  _getCurrencies = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
...
select.oninput = convertValue; //функція конвертації
